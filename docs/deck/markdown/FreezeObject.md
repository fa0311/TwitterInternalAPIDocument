...
```internal process
# Error
{[r.HOME]:"home",[r.HOME_LATEST]:"latest",[r.LIST]:"pinned_list"}
```
| constant     | value         |
|:-------------|:--------------|
| ContinueWith | continue_with |
...
```internal process
# Error
{[E.DEFAULT]:"P.UNDETERMINED",[E.DENIED]:"P.OFF",[E.GRANTED]:"P.ON"}
```
| constant   | value                                        |
|:-----------|:---------------------------------------------|
...
```internal process
# Error
{[c.top]:{"label":"r().b1afa50a","value":"c.top"},[c.latest]:{"label":"r().ade3c688","value":"c.latest"}}
```
```internal process
# Error
{[o.y7.wide]:{"label":"r().bd4ad3ea","value":"o.y7.wide"},[o.y7.medium]:{"label":"r().ca1180a0","value":"o.y7.medium"},[o.y7.narrow]:{"label":"r().c86ff1b0","value":"o.y7.narrow"}}
```
```internal process
# Error
{[o.eC.small]:{"label":"r().eed02406","value":"o.eC.small"},[o.eC.cropped]:{"label":"r().cffb04d6","value":"o.eC.cropped"}}
```
| constant             | value                |
|:---------------------|:---------------------|
...
| brandColor                      | d.Z.color.baseColor.blue500    |
| whiteOnColor                    | o.Cj                           |
...
| brandColor                      | d.Z.color.darkColor.gray1000 |
| whiteOnColor                    | o.Cj                         |
| buttonBlack                     | d.Z.color.baseColor.gray50   |
| buttonWhite                     | d.Z.color.baseColor.gray1100 |
| buttonOutlinedBorder            | d.Z.color.baseColor.gray700  |
...
| space2     | t()                 |
| space4     | t(m.spaces.space2)  |
| space8     | t(m.spaces.space4)  |
| space12    | t(m.spaces.space8)  |
| space16    | t(m.spaces.space12) |
| space20    | t(m.spaces.space16) |
| space24    | t(m.spaces.space20) |
| space28    | t(m.spaces.space24) |
| space32    | t(m.spaces.space28) |
| space36    | t(m.spaces.space32) |
| space40    | t(m.spaces.space36) |
| space48    | t(m.spaces.space40) |
| space56    | t(m.spaces.space48) |
| space64    | t(m.spaces.space56) |
| space72    | t(m.spaces.space64) |
| space80    | t(m.spaces.space72) |
...
| constant                 | value                    |
|:-------------------------|:-------------------------|
| ExcludeMentioningSomeone | excludeMentioningSomeone |
| ExcludeReplyingToSomeone | excludeReplyingToSomeone |
| ExcludeTweetsFromSomeone | excludeTweetsFromSomeone |
| ExcludeExactPhrase       | excludeExactPhrase       |
| ExcludeWords             | excludeWords             |
| FromTime                 | fromTime                 |
| IncludeAllOfTheseWords   | includeAllOfTheseWords   |
| IncludeAnyOfTheseWords   | includeAnyOfTheseWords   |
| IncludeExactPhrase       | includeExactPhrase       |
| IncludeList              | includeList              |
| IncludeMentioningSomeone | includeMentioningSomeone |
| IncludeReplyingToSomeone | includeReplyingToSomeone |
| IncludeTweetsFromSomeone | includeTweetsFromSomeone |
| LanguagesSelector        | languagesSelector        |
| Likes                    | likes                    |
| LikesSelector            | likesSelector            |
| Replies                  | replies                  |
| RepliesSelector          | repliesSelector          |
| Retweets                 | retweets                 |
| RetweetsSelector         | retweetsSelector         |
| ToTime                   | toTime                   |
...
| constant           | value              |
|:-------------------|:-------------------|
| OnlyShowBroadcasts | onlyShowBroadcasts |
| OnlyShowFollows    | onlyShowFollows    |
| OnlyShowImages     | onlyShowImages     |
| OnlyShowLinks      | onlyShowLinks      |
| OnlyShowGIFs       | onlyShowGIFs       |
| OnlyShowMedia      | onlyShowMedia      |
| OnlyShowVerified   | onlyShowVerified   |
| OnlyShowVideos     | onlyShowVideos     |
...
| welcomeLegacyUser | welcomeLegacyUser |
...
```internal process
# Error
{"ActionsBar":"y.Z","ActionMenu":"function()"{"Icon":"e","isDisabled":"t","items":"n","onOpen":"o"}{"const r=i.useCallback()"{"items":"n","onCloseRequested":"e"}{"Icon":"e","isDisabled":"t","onClick":"o","renderActionMenu":"r"}},"CallToAction":"a.ZP","EditCallout":"f.Z","Education":"C.Z","Highlighte...
```
| constant             | value                |
|:---------------------|:---------------------|
| Bird                 | Bird                 |
...
| constant      | value        |
|:--------------|:-------------|
| superFollower | y().b0063ac6 |

| constant      | value        |
|:--------------|:-------------|
| superFollower | y().fc065ee4 |

| constant      | value                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| superFollower | {'graphic': 'p.default', 'headline': 'y().ca80fe70', 'subtext': 'y().c4183c30', 'actionLabel': 'y().g7099a02', 'actionLink': 'https://help.twitter.com/en/using-twitter/super-follows#sfexpect', 'secondaryActionLabel': 'y().c2637ef6'} |

| constant      | value                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| superFollower | {'graphic': 'p.default', 'headline': 'y().e453f536', 'subtext': 'y().dea63fc4', 'actionLabel': 'y().g7099a02', 'actionLink': 'https://help.twitter.com/en/using-twitter/super-follows#sfexpect', 'secondaryActionLabel': 'y().c2637ef6'} |

| constant        | value        |
|:----------------|:-------------|
| followsYou      | y().efb17190 |
| superFollowsYou | y().a7c3a6e0 |
| superFollower   | y().a3df6df8 |

| constant        | value        |
|:----------------|:-------------|
| followsYou      | y().efb17190 |
| superFollowsYou | y().g57b5f6c |
| superFollower   | y().e589ffa8 |
...
| community                 | {'icon': 'sn', 'label': 'S().ec5a4a26'} |
| by_invitation             | {'icon': 'nn', 'label': 'S().b454300a'} |
| community_members         | {'icon': 'an', 'label': 'S().i13be5a0'} |
| super_followers_exclusive | {'icon': 'tn', 'label': 'S().feb7560a'} |
| trusted_friends_tweet     | {'icon': 'on', 'label': 'd'}            |

```internal process
# Error
{[_o.Original]:"OriginalTweet",[_o.Quote]:"QuoteTweet",[_o.Reply]:"Reply",[_o.Thread]:"Retweet"}
```
| constant   | value   |
|:-----------|:--------|
| in         | in      |
...
```internal process
# Error
{[_o.Original]:"original_tweet",[_o.Quote]:"quote_tweet",[_o.Reply]:"reply"}
```
| constant            | value                              |
|:--------------------|:-----------------------------------|
...
```internal process
# Error
{"ActionsBar":"b.Z","ActionMenu":"function()"{"Icon":"e","isDisabled":"t","items":"n","onOpen":"i"}{"const o=r.useCallback()"{"items":"n","onCloseRequested":"e"}{"Icon":"e","isDisabled":"t","onClick":"i","renderActionMenu":"o"}},"CallToAction":"a.ZP","EditCallout":"f.Z","Education":"C.Z","Highlighte...
```
| constant       | value          |
|:---------------|:---------------|
| TWEET_CARET    | tweet_caret    |
...
```internal process
# Error
{[x.ActionedTweets]:{"backLocation":"I","confirmationSheetHeadline":"()(0,o.X_)"{"screenName":"m"}{"screenName":"m"}},[x.PreviewFlaggedTweets]:{"backLocation":"A","confirmationSheetHeadline":"S()"{"screenName":"m"}{"screenName":"m"}}}
```
| constant             | value                  |
|:---------------------|:-----------------------|
...
| confirmationSheetText | l().abc600f4 |
...
| confirmationSheetText | l().aa3ba124 |
...
| confirmationSheetText | l().i36c403c |
...
| constant      | value                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| superFollower | {'graphic': 'h.default', 'headline': 'p().ca80fe70', 'subtext': 'p().c4183c30', 'actionLabel': 'p().g7099a02', 'actionLink': 'https://help.twitter.com/en/using-twitter/super-follows#sfexpect', 'secondaryActionLabel': 'p().c2637ef6'} |

| constant      | value                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| superFollower | {'graphic': 'h.default', 'headline': 'p().e453f536', 'subtext': 'p().dea63fc4', 'actionLabel': 'p().g7099a02', 'actionLink': 'https://help.twitter.com/en/using-twitter/super-follows#sfexpect', 'secondaryActionLabel': 'p().c2637ef6'} |
...
```internal process
# Error
{"ActionsBar":"C.Z","ActionMenu":"function()"{"Icon":"e","isDisabled":"t","items":"n","onOpen":"r"}{"const a=i.useCallback()"{"items":"n","onCloseRequested":"e"}{"Icon":"e","isDisabled":"t","onClick":"r","renderActionMenu":"a"}},"CallToAction":"l.ZP","EditCallout":"f.Z","Education":"_.Z","Highlighte...
```
| constant   | value    |
|:-----------|:---------|
| original   | original |
...
| constant      | value                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| superFollower | {'graphic': 'g.default', 'headline': 'p().ca80fe70', 'subtext': 'p().c4183c30', 'actionLabel': 'p().g7099a02', 'actionLink': 'https://help.twitter.com/en/using-twitter/super-follows#sfexpect', 'secondaryActionLabel': 'p().c2637ef6'} |
...
| constant      | value                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| superFollower | {'graphic': 'b.default', 'headline': 'p().ca80fe70', 'subtext': 'p().c4183c30', 'actionLabel': 'p().g7099a02', 'actionLink': 'https://help.twitter.com/en/using-twitter/super-follows#sfexpect', 'secondaryActionLabel': 'p().c2637ef6'} |

| constant      | value                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| superFollower | {'graphic': 'b.default', 'headline': 'p().e453f536', 'subtext': 'p().dea63fc4', 'actionLabel': 'p().g7099a02', 'actionLink': 'https://help.twitter.com/en/using-twitter/super-follows#sfexpect', 'secondaryActionLabel': 'p().c2637ef6'} |
...
```internal process
# Error
{"default":()=>r().g784d3c6,"with_replies":()=>r().g784d3c6,"superfollows":()=>r().ib53965c}
```
```internal process
# Error
{"default":()=>r().g784d3c6,"with_replies":()=>r().g784d3c6,"superfollows":()=>r().ce659062}
```
```internal process
# Error
{"default":()=>r().d1e5e328,"with_replies":()=>r().d1e5e328,"superfollows":()=>r().cb1915b0}
```
```internal process
# Error
{"default":()=>r().d1e5e328,"with_replies":()=>r().d1e5e328,"superfollows":()=>r().bb3406a6}
```
| constant     | value        |
|:-------------|:-------------|
| default      | r().dc1f8991 |
| with_replies | r().dc1f8991 |
| superfollows | r().d5aaa25b |

| constant     | value        |
|:-------------|:-------------|
| default      | r().dc1f8991 |
| with_replies | r().dc1f8991 |
| superfollows | r().ba145149 |

```internal process
# Error
{"default":()=>r().e4f9514c,"with_replies":()=>r().e4f9514c,"superfollows":()=>r().b8a9719a}
```
```internal process
# Error
...
| constant      | value                                                                                                                                                                                                                                    |
|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| superFollower | {'graphic': 'y.default', 'headline': 'm().ca80fe70', 'subtext': 'm().c4183c30', 'actionLabel': 'm().g7099a02', 'actionLink': 'https://help.twitter.com/en/using-twitter/super-follows#sfexpect', 'secondaryActionLabel': 'm().c2637ef6'} |
