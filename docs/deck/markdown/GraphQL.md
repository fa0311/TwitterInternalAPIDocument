...
`None`<br>
## UserByScreenName<br>
Request URL: `https://x.com/i/api/graphql/laYnJPCAcVo0o6pzcnlVxQ/UserByScreenName`<br>
Request Method: `GET`<br>
Login Required: `...`<br>
### Param<br>
#### variables<br>
...
Request URL: `https://x.com/i/api/graphql/TCCuBAotz4ejz0_9iGjm6w/BirdwatchFetchOneNote`<br>
Request Method: `GET`<br>
Login Required: `...`<br>
### Param<br>
#### variables<br>
