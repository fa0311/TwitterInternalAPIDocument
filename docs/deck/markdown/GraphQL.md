...
```internal process
# Error
{"articleEntityId":"i","coverMedia":"s&&a?"{"media_id":"s","media_category":"a"}:"void 0"}
```
#### features<br>
| key                                                                     | type    | variable   |
|:------------------------------------------------------------------------|:--------|:-----------|
...
Request URL: `https://x.com/i/api/graphql/svgZ7bxxbNNiMhBF4PsWww/BirdwatchFetchNoteTranslation`<br>
Request Method: `GET`<br>
Login Required: `...`<br>
### Param<br>
#### variables<br>
