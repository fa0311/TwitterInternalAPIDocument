...
| constant                  | value                                   |
|:--------------------------|:----------------------------------------|
| all                       | {'icon': 'is', 'label': 'C().i8ea6d4e'} |
| community                 | {'icon': 'ns', 'label': 'C().ec5a4a26'} |
| by_invitation             | {'icon': 'ss', 'label': 'C().b454300a'} |
| subscribers               | {'icon': 'is', 'label': 'C().bf8d98f4'} |
| community_members         | {'icon': 'as', 'label': 'C().i13be5a0'} |
