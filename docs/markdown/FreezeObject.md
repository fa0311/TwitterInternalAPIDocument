...
```internal process
# Error
{[P.VerificationCheck]:"function()"{if()throw new Error(3!==e.length);const[d,a,n]=e;return[{"width":"400","height":"200","uri":"d"},{"width":"800","height":"400","uri":"a"},{"width":"1200","height":"600","uri":"n"}]}"()"}
```
| constant      | value        |
|:--------------|:-------------|
