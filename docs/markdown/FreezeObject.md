...
```internal process
# Error
{[Ea.Original]:"OriginalTweet",[Ea.Quote]:"QuoteTweet",[Ea.Reply]:"Reply",[Ea.Thread]:"Retweet"}
```
| constant   | value   |
|:-----------|:--------|
| in         | in      |
...
```internal process
# Error
{[Ea.Original]:"original_tweet",[Ea.Quote]:"quote_tweet",[Ea.Reply]:"reply"}
```
| constant            | value                              |
|:--------------------|:-----------------------------------|
