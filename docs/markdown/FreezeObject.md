...
```internal process
# Error
{[B.VerificationCheck]:"function()"{if()throw new Error(3!==e.length);const[t,a,n]=e;return[{"width":"400","height":"200","uri":"t"},{"width":"800","height":"400","uri":"a"},{"width":"1200","height":"600","uri":"n"}]}"()"}
```
| constant    | value       |
|:------------|:------------|
| RESIZE      | resize      |
