...
### Feature Switch<br>
#### add<br>
- av_chat_xchat_emoji_reactions_enabled<br>
- composer_add_geo_network_conversation_controls<br>
- composer_composition_signals_enabled<br>
- content_disclosure_c2pa_detection_exemption_list<br>
- payments_auth_token_enabled<br>
- responsive_web_grok_img_composer_redirect_to_grok_com_imagine<br>
- responsive_web_native_bridge_allowed_methods<br>
- rweb_media_multi_requests_default_pool_size<br>
- rweb_xchat_categories_dropdown<br>
- rweb_xchat_search_redesign<br>
- subscriptions_management_failed_payment_paywall_banner_enabled<br>
- xchat_additional_reply_preview_validation_required_seqnum_str<br>
- xchat_drafts_bump_to_top<br>
- xchat_drop_messages_failing_franking_verification<br>
- xchat_drop_sigs_after_seq_num_str<br>
- xchat_enable_default_disappearing_messages_setting<br>
- xchat_enable_franking_report<br>
- xchat_enable_in_memory_event_retry_bottom_cursor<br>
- xchat_enable_reaction_notifs<br>
- xchat_enforce_media_hash_verification<br>
- xchat_franking_required_after_seq_num<br>
- xchat_franking_required_after_seq_num_str<br>
- xchat_grpc_chat_page_enabled<br>
- xchat_hide_pending_members_for_non_admin<br>
- xchat_inbox_conversation_limit_subsequent<br>
- xchat_pay_button_enabled<br>
- xchat_ratchet_group_id_threshold_str<br>
- xchat_self_custody_enabled<br>
- xchat_send_franking_data<br>
- xchat_send_signature_protocol_version<br>
- xchat_streamed_link_preview<br>
- xchat_voice_messages_transcription_enabled<br>
#### remove<br>
...
### Feature Switch<br>
#### add<br>
- co_timeline_topic_filter_enabled<br>
- payments_secondary_accounts_enabled<br>
- payments_shared_accounts_enabled<br>
- responsive_web_birdwatch_crowd_nmr_pivots_enabled<br>
- responsive_web_birdwatch_show_note_request_sources_despite_top_writer_status<br>
- rweb_cashtags_composer_enabled<br>
- rweb_cashtags_trade_deeplink_enabled<br>
- rweb_xchat_remove_x_pro_dms<br>
- rweb_xchat_ws_only_when_active<br>
- subscriptions_marketing_page_compare_table_ctas_enabled<br>
- subscriptions_marketing_page_stripe_optimization_enabled<br>
- subscriptions_verified_to_premium_enabled<br>
- video_attribution_display_over_video_cards_enabled<br>
- xchat_enable_message_requests_attachments<br>
- xchat_enable_single_message_locking<br>
- xchat_fetch_messages_from_push_handler<br>
- xchat_invalid_sig_log_after_seq_num_str<br>
- xchat_markdown_rendering_enabled<br>
#### remove<br>
- rweb_xchat_categories_dropdown<br>
- rweb_xchat_search_redesign<br>
## 2026/05/02<br>
...
### Feature Switch<br>
#### add<br>
- hometimeline_pinned_tabs_limit<br>
- hometimeline_pinned_tabs_management_pinnedsection_inline_limit<br>
- hometimeline_pinned_tabs_management_topics_inline_limit<br>
- oauth_consent_account_switch_enabled<br>
- premium_webview_paywall_custom_timelines_feature_enabled<br>
- responsive_web_birdwatch_media_history_enabled<br>
- responsive_web_service_worker_update_toast_interval_hours<br>
- rweb_cashtags_composer_attachment_enabled<br>
- subscriptions_premium_hub_boost_block_enabled<br>
- xstudio_embed_origin<br>
- xstudio_rweb_live_studio_enabled<br>
- rweb_quick_promote_third_party_boost_enabled<br>
#### remove<br>
- None<br>
## 2026/06/21<br>
### API<br>
...
### Feature Switch<br>
#### add<br>
- av_chat_group_e2ee_creator_enabled<br>
- av_chat_group_e2ee_joiner_enabled<br>
- payments_funds_insurance_redesign_enabled<br>
- payments_funds_insurance_sweep_enabled<br>
- payments_support_grpc_enabled<br>
- payments_support_xchat_sessions_enabled<br>
- payments_web_external_app_enabled<br>
- responsive_web_android_quick_promote_stripe_elements_enabled<br>
- responsive_web_birdwatch_note_request_suggestion_enabled<br>
- responsive_web_grok_build_tab_relabel_enabled<br>
- responsive_web_media_upload_appendmulti_max_concurrent_requests<br>
- responsive_web_media_upload_appendmulti_pre_read_blob<br>
- responsive_web_media_upload_host<br>
- responsive_web_notifications_refresher_enabled<br>
- responsive_web_quick_promote_cta_enabled<br>
- responsive_web_quick_promote_high_budget_tier_enabled<br>
- responsive_web_twitter_article_table_enabled<br>
- rweb_analytics_active_followers_enabled<br>
- rweb_analytics_control_v2_enabled<br>
- rweb_analytics_hourly_overview_enabled<br>
- rweb_cashtags_composer_attachment_size_customization_enabled<br>
- rweb_home_jot_context_enabled<br>
- subscriptions_offers_go_for_launch_copy_enabled<br>
- subscriptions_offers_premium_nav_indicator_variant<br>
- subscriptions_upsells_post_limit_toast<br>
- web_video_persist_bandwidth_estimate_enabled<br>
- x_android_apollo_graphql_accept_header<br>
- x_android_apollo_graphql_accept_header_override<br>
- xai_profile_redirect_enabled<br>
- xchat_ckey_recovery_enabled<br>
- xchat_dm_media_upload_workmanager_enabled<br>
- xchat_enable_message_request_ui_v3<br>
- xchat_enable_undecryptable_tombstones<br>
- xchat_group_admin_settings_enabled<br>
- xchat_keypair_recovery_enabled<br>
- xchat_max_message_plaintext_length_bytes<br>
- xchat_media_download_io_batching_enabled<br>
- xchat_media_resolve_threshold_fast_network_bytes_str<br>
- xchat_media_resolve_threshold_slow_network_bytes_str<br>
- xchat_media_upload_io_batching_enabled<br>
- xchat_message_composer_v2<br>
- xchat_plaintext_grok_enabled<br>
- xchat_repair_groups_after_passcode_reset<br>
- xchat_separate_reactions_table_enabled<br>
- xchat_unread_mismatch_scribing_enabled<br>
- xchat_url_preview_v2_enabled<br>
...
### Feature Switch<br>
#### add<br>
- payments_business_onboarding_support<br>
- payments_international_wires_enabled<br>
- responsive_web_grok_imagine_banner_config<br>
- rweb_under_the_hood_report_enabled<br>
#### remove<br>
...
### Feature Switch<br>
#### add<br>
- responsive_web_nfl_enabled<br>
- responsive_web_nfl_sidebar_enabled<br>
- x_sports_nfl_favorite_teams_enabled<br>
- x_sports_nfl_game_chat_enabled<br>
- x_sports_nfl_game_feed_enabled<br>
- x_sports_nfl_game_odds_card_enabled<br>
- x_sports_nfl_hub_home_timeline_tag<br>
...
### Feature Switch<br>
#### add<br>
- android_ui_nested_quote_tweet_preview_enabled<br>
- grok_translations_community_note_auto_translation_is_enabled<br>
- grok_translations_community_note_translation_is_enabled<br>
- grok_translations_post_auto_translation_is_enabled<br>
- immersive_video_status_linkable_timestamps<br>
- payments_csv_export_enabled<br>
- responsive_web_qp_budgets_by_billing_currency_enabled<br>
- responsive_web_verified_organizations_application_requirements_enabled<br>
- rweb_under_the_hood_report_jetfuel_enabled<br>
- rweb_xchat_call_health_enabled<br>
- rweb_xchat_client_stats_enabled<br>
- unified_cards_destination_url_params_enabled<br>
- x_lite_quick_promote_analytics_banner_enabled<br>
- x_sports_post_context_enabled<br>
- xcall_link_devices_enabled<br>
#### remove<br>
- rweb_video_host_enabled<br>
- x_jetfuel_event_screen_migration_enabled<br>
- x_jetfuel_event_screen_migration_skip_ids<br>
